...
import styles from './ScaleTweenCarousel.module.css'

const TWEEN_FACTOR_BASE = 0.52

function ScaleTweenCarousel() {
  ...
  const tweenScale = useCallback((api: EmblaCarouselType, eventName?: EmblaEventType) => {
    ...
    api.scrollSnapList().forEach((scrollSnap, snapIndex) => {
      ...
      slidesInSnap.forEach((slideIndex) => {
        ...
        const scale = numberWithinRange(tweenValue, 0.6, 1)
...
export default ScaleTweenCarousel
